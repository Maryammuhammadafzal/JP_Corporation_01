...
const AboutCard = () => {
  return (
    <>
      <div className="w-[30%] h-[350px] max-[1200px]:w-[350px] max-[1050px]:w-[350px] max-[800px]:w-[350px]  flex flex-col justify-between items-center">
        <div className="cardIcons w-full h-auto flex  justify-center items-center p-3">
          <div className="round bg-red-100 rounded-full h-[80px] flex justify-center items-center w-[80px]">
            <svg
        ...
        <div className="cardTitle w-full text-2xl font-bold h-auto text-center p-3">
          <h4>Wide range of brands</h4>
        </div>
        <div className="carddescription w-full h-auto text-center p-3">
      ...
      <div className="w-[30%] h-[350px] max-[1200px]:w-[350px] max-[1050px]:w-[350px] max-[800px]:w-[350px] flex flex-col justify-between items-center">
        <div className="cardIcons w-full h-auto flex  justify-center items-center p-3">
          <div className="round bg-green-100 rounded-full h-[80px] flex justify-center items-center w-[80px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="37.001"
              height="32"
      ...
      <div className="w-[30%] h-[350px] max-[1200px]:w-[350px] max-[1050px]:w-[350px] max-[800px]:w-[350px] flex flex-col justify-between items-center">
        <div className="cardIcons w-full h-auto flex  justify-center items-center p-3">
          <div className="round bg-blue-100 rounded-full h-[80px] flex justify-center items-center w-[80px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="28"
              height="44.654"
